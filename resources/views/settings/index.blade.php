				...
				<form id="settings_form" action="" method="POST">
					...
					<div class="col-md-6">
						<div class="form-group">				    
						    <input type="email" name="admin_email" class="form-control" id="admin_email" value=""  data-old="">
						    @error('email')
					...
					<div class="col-md-6">
						<div class="form-group">					    
						<select class="form-control" name="language" id="language" data-old="">
					...
					<div class="col-md-6">
						<div class="form-group">				    
							<select class="form-control" id="timezone" name="timezone" data-old="">
					...
					<div class="col-md-6">
						<div class="form-group">				    
						    <!-- <input type="text" name="currency" class="form-control" id="currency" value="" data-old=""> -->
							<select name="currency" class="form-control" id="currency" value="" data-old="">
					...
					<div class="form-group">
						    <button type="button" name="submit" class="btn btn-primary submit-settings-frm">{{ __('Save Settings') }}</button>
					</div>	
				</form>
			</div>
			<!-- /.box-body -->
