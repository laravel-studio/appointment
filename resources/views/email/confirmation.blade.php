              ...
              <table class="email-body_inner" align="center" width="570" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  <td class="content-cell">
                    ...
                    <p>{{__('messages.hello')}} {{$name}} Thanks for signing up for Canvas! We're excited to have you as an early user.</p>
                    <!-- Action -->
                      ...
                      <tr>
                        <td align="center">
                          <div>
                            ...
                            <a href="{{$url}}{{base64_encode($id)}}" class="button button--blue">Verify Email</a>
                          </div>
                        </td>
                      </tr>
                    </table>
